...
執行窗口直接產 `comfyui-conflicts-{pack}.md` 完整檔案,template 參考 [`conflicts-kjnodes.md`](conflicts-kjnodes.md)(KJNodes 第一份)。標準段落:
...
- **`conflicts-kjnodes.md`**:KJNodes 衝突明細(per-pack template,以後其他 pack 比照命名 `comfyui-conflicts-{pack}.md`)
